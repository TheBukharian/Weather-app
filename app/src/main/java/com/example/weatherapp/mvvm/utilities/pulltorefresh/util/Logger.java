package com.example.weatherapp.mvvm.utilities.pulltorefresh.util;
...
public final class Logger {
    ...
    private static final boolean logEnabled_d = false;
    private static final boolean logEnabled_i = false;
    private static final boolean logEnabled_e = false;
