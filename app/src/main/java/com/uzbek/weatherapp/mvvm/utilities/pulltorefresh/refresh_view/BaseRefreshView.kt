package com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.refresh_view
...
abstract class BaseRefreshView(context: Context?, layout: com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.PullToRefreshView?) : Drawable(),
    Drawable.Callback, Animatable {

    private val mRefreshLayout: com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.PullToRefreshView? = layout
    private var mEndOfRefreshing = false
    val context: Context?
        get() = mRefreshLayout?.context
    val refreshLayout: com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.PullToRefreshView?
        get() = mRefreshLayout
