package com.uzbek.weatherapp.mvvm.utilities.pulltorefresh;
...
import com.example.weatherapp.mvvm.utilities.pulltorefresh.refresh_view.BaseRefreshView;
import com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.refresh_view.SunRefreshView;
import com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.util.Utils;
import com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.refresh_view.BaseRefreshView;
import com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.refresh_view.SunRefreshView;
import com.uzbek.weatherapp.mvvm.utilities.pulltorefresh.util.Utils;
...
public class PullToRefreshView extends ViewGroup {
    ...
    private void setRefreshing(boolean refreshing, final boolean notify) {
        if (mRefreshing != refreshing) {
            Log.d("wcmomwc","called2");

            mNotify = notify;
            ensureTarget();
            mRefreshing = refreshing;
            if (mRefreshing) {
                Log.d("wcmomwc","called3");
